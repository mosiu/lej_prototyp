...
***************************DECLARATIONS OF "hd44780.c" FUNCTIONS**********************************/
  ...
  */
 void    hd44780_wait_ready(uint8_t islong);
...
/*
***************************************NEW MACROS' DEFINITIONS*******************************************
*/
 /* Send a command to the LCD controller. n means command, e.g. one of the macros defined below */
 #define hd44780_outcmd(n)       hd44780_outbyte((n), 0)

 /* Send a data byte to the LCD controller. n means command, e.g. one of the macros defined below */
